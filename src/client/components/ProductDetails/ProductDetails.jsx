    ...
    return (
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex flex-wrap space-x-5 justify-center">
                            {product.images.map((productImage) => <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4">
                                <img
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-50 text-sm'>300 Ratings</p>
                ...
                {/* rating and reviews */}
                <section>
                    <h1 className='font-bold text-lg pb-4'>Recent Ratings & Reviews</h1>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>250 Ratings</p>
                                </div>

                                <Box className='mt-5 space-y-3'>

                                    <Grid container alignItems='center' gap={2} className=''>
                                        <Grid item xs={2}>
                                           <p>Excellent</p>
                                        </Grid>
                                        <Grid item xs={7}>
                ...
                {/* similer products */}
                <section>
                    <h1 className='py-5 font-bold text-xl'>Similer Products</h1>

                    <div className='flex flex-wrap space-y-5'>
                        {mens_t_shirt.map((item)=><ProductCard product={item}/>)}
                    </div>
                </section>
